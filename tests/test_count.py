...
class TestPlate(unittest.TestCase):
    ...
    def test_count_BioPlate(self):
        self.assertDictEqual(BioPlateCount(self.plt.set(self.Value)), {'' : 80, 'Control' : 1, 'Test1' : 9, 'Test2' : 6})
        self.assertDictEqual(BioPlateCount(self.plt.set(self.Value), reverse=True), {'' : 80, 'Control' : 1, 'Test2' : 6, 'Test1' : 9})
        
    def test_count_BioPlateInserts(self):
        self.Inserts.top.set(self.Value)
        self.Inserts.bot.set(self.Value2)
        self.assertDictEqual(BioPlateCount(self.Inserts), { "top" : {'Control' : 1, "Test1": 9, "Test2" : 6, '' : 80 }, "bot" : {'Control1' : 1, "Test3": 8, "Test4" : 7, '' : 80} })
        
    def test_count_BioPlateStack_BioPlate(self):
        self.plt.set(self.Value)
        self.plt1.set(self.Value2)       
        self.assertDictEqual(BioPlateCount(self.stack), { 0 : {'Control' : 1, "Test1": 9, "Test2" : 6, '' : 80 }, 1 : {'Control1' : 1, "Test3": 8, "Test4" : 7, '' : 80} })
    ...
    def test_count_BioPlateStack_BioPlateInserts(self):
        ...
        self.assertEqual( BioPlateCount(self.stacki), 
        {0 : 
            { "top" : 
            {'Control' : 1, "Test2": 6, "Test1" : 9, '' : 80}, 
              "bot" : 
            {'Control1' : 1, "Test3": 8, "Test4" : 7, '' : 80}},
         1 : 
             { "top" : 
              {'Control' : 1, "Test1": 9, "Test2" : 6, '' : 80 }, 
              "bot" : 
            {'Control1' : 1, "Test3": 8, "Test4" : 7, '' : 80}} })
