...
class TestMatrix(unittest.TestCase):
    ...
    def test_index_row_column(self):
        ...
        self.assertEqual(
            BioPlateMatrix._index_row_column("D", "10"), bpu.EL("W", 4, 10)
        )
        self.assertEqual(
        ...
        self.assertEqual(
            BioPlateMatrix._index_row_column("G", "5-8"), bpu.EL("R", 7, slice(5, 9, 1))
        )
        self.assertEqual(
            BioPlateMatrix._index_row_column("B-E", "5"), bpu.EL("C", slice(2, 6, 1), 5)
        )
    ...
    def test_all_row_column(self):
        self.assertEqual(
            BioPlateMatrix._all_row_column("A"), bpu.EL("R", 1, slice(1, None))
        )
        self.assertEqual(
            BioPlateMatrix._all_row_column(3), bpu.EL("C", slice(1, None), 3)
        )
