...
class TestPlate(unittest.TestCase):
    ...
    def test_general(self):
        self.assertEqual(BioPlateMatrix("A2"), (1,2))
        self.assertEqual(BioPlateMatrix("5G"), (7, 5))
        self.assertEqual(BioPlateMatrix("B[2,8]"), ('C', 2, 2, 9))
        self.assertEqual(BioPlateMatrix("B[2-8]"), ('C', 2, 2, 9))
    ...
    def test_index_row_column(self):
        self.assertEqual(BioPlateMatrix._index_row_column('A', '1'), (1, 1))
        self.assertEqual(BioPlateMatrix._index_row_column('D', '10'), (4, 10))
        self.assertEqual(BioPlateMatrix._index_row_column('D-G', '10'), ('R', 4,  8, 10))
        self.assertEqual(list(BioPlateMatrix._index_row_column('G-I', '5-8')), [('C', 7,  5, 9), ('C', 8, 5, 9), ('C', 9, 5, 9)])
        self.assertEqual(BioPlateMatrix._index_row_column('G', '5-8'), ('C', 7,  5, 9))
        self.assertEqual(BioPlateMatrix._index_row_column('B-E', '5'), ('R', 2,  6, 5))
